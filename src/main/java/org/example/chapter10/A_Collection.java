...
// 2) List
//      : 데이터의 순서가 유지되고 (index 번호), 중복 가능
//      - 주요 구현제: ArrayList, LinkedList, Vector 등

// 3) Set
//      : 데이터의 순서유지 X, 중복 불가능 (cf. 특정 구현체-클래스 는 정렬 | 순서 제공 가능)
//      - 주요 구현체: HastSet, TreeSet, LinkedHashSet

// 4) Map
//      : 키(key) - 값(value) 쌍으로 이루어진 데이터를 다룸
//      - 키(중복 허용 X), 값(중복 허용 O)
//      - 주요 구현체: HashMap, TreeMap, LinkedMap

// cf) Queue(큐): FIFO(Fist In First Out)
