...
/*
    ...
    - 가독성이 증가: 사용 시 타입 명시로 코드 의도 파악 가능 (코드의 명확성 증가)
    ...
    cf) 타입 매개변수(타입 변수)
            ...
            <T>: Type 약자 (가장 흔하게 사용) // 아무타입이나 들어올 수 있다.
            <K, V>: Key, Value의 구조 (Map 구조에서 주로 사용)
            K: 키 타입을 표현할 때 // V: 값 타입을 표현할 때
            <E>: Element (컬렉션에서 주로 사용) // 리스트, 세트 등
 */
